...
<footer className="bg-gray-900 dark:bg-gray-900">
    ...
    <div className="px-4 py-6 bg-gray-700 rounded-xl dark:bg-gray-700 md:flex md:items-center md:justify-between">
        ...
        <div className="flex mt-4 pu-2 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
